...
@section('content')
    <div class="row justify-content-center mt-5">
        <div class="col-md-10">
            <h3 class="fw-semibold mb-3">Trashed</h3>
            <div class="card border rounded-1 shadow-sm">

                <div class="card-body border-bottom pb-3 pt-3">
                    <div class="row align-items-center g-2">
                        <div class="col-md-2">
                            <a href="{{ route('customers.index') }}" class="btn btn-dark rounded-1 w-100">
                        ...
                        <div class="col-md-1">
                            <a href="" class="btn btn-outline-danger rounded-1 w-100">
                                ...
                                <tr class="align-middle">
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('customers.restore', $customer->id) }}" style="color: #2c2c2c;"
                                            class="ms-1 me-1"><i class="fa fa-undo" aria-hidden="true"></i></a>
