                    ...
                    <form action="{{ route('customers.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="phone"
                                        placeholder="+880 171 000 0000" value="{{ old('phone') }}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-12 mb-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="bank_account_number"
                                        placeholder="e.g. 4002-0012-4567" value="{{ old('bank_account_number') }}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-12 mb-4">
                                <div class="form-group">
                                    <label>About</label>
                                    <textarea class="form-control" name="about" placeholder="Short note about this customer…">{{ old('about') }}</textarea>
                                </div>
                            </div>
